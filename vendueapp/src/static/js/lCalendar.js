...
window.lCalendar = (function() {
    var MobileCalendar = function() {
    	...
    	var date = new Date();
        this.gearDate;
        this.minY = parseInt(date.getFullYear());
        this.minM = parseInt(date.getMonth())+1;//date.getMonth();
        this.minD = parseInt(date.getDate());
        this.maxY = parseInt(date.getFullYear())+10;
        this.maxM = 12;
        this.maxD = 31;
    }
...
//                  '</div>' +
            ...
            function finishMobileDate(e) {
                ...
                //将选择的日期赋值到 页面位置
               // _self.trigger.querySelector(".fix-date").value = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd;
